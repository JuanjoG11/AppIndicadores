...
const Login = ({ onLogin }) => {
    ...
    const roles = [
        ...
        { id: 'CONTABILIDAD', name: 'Contabilidad', desc: 'Gasto de fletes, rentabilidad y cierres', icon: <Calculator size={24} />, companies: ['TYM', 'TAT'], allowedAreas: ['contabilidad'], color: '#f59e0b', password: 'admin2026' },
        { id: 'INFORMACIÓN/INVENTARIO', name: 'Información e Inventario', desc: 'Picking, fiabilidad y obsolescencia', icon: <ClipboardList size={24} />, companies: ['TYM', 'TAT'], allowedAreas: ['administrativo'], color: '#10b981', password: 'admin2026' },
